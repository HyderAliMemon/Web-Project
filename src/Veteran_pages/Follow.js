...
return (
    <>
        ...
        <div className="input-container">
            <label className="event-label1">Email</label>
            <input className="event-input" value={email} required onChange={(e) => {setEmail(e.target.value)}} type="email" placeholder="Please Enter Email" id="invite-email" name="send-invite" />   
        </div>
